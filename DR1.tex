...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.3]{LDI_colour_image.jpg}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.3]{ADT_colour_image.jpg}
...
The ECG device is built based on the instruction diagram below.
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.3]{ecg_circuit_diagram.png}
        \caption{EKG circuit diagram}
\end{figure}
...
noise from the ECG digitally, and outputs ECG traces for further analysis.\\
\\
This is the circuit we built.
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.1]{EKG_photo.jpg}
        \caption{EKG circuit}
\end{figure}
